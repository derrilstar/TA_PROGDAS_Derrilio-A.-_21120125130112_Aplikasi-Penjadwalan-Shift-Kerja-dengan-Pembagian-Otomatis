...
class ShiftScheduler:
    def __init__(self, daftar_karyawan, jumlah_hari=7, kapasitas_per_shift=1, mode="normal"):
        base_hari = ["Senin", "Selasa", "rabu", "kamis", "jumat", "sabtu", "minggu"]
    ...
    def __init__(self, jumlah_hari=7):
        base_hari = ["Senin", "Selasa", "rabu", "kamis", "jumat", "sabtu", "minggu"]
